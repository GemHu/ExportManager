...
namespace Dothan.DBFFileMamager
{
    public class TradeRow_O32
    {
        ...
        /// <summary>
        /// 03、业务分类; 	1、交易所业务；4、期货业务；I、上交所固定收益平台；; 字段类型 = char(1)
        /// </summary>
        ...
        /// <summary>
        /// 11、委托方向; 	1、买入；2、卖出；3、债券买入；4、债券卖出；5、融资回购；6、融券回购；X、卖出开仓；Y、买入平仓；V、买入开仓；W、卖出平仓；; 字段类型 = char(1)
        /// </summary>
        public char C_ENTRUST_DIRECTION { get; set; }

        /// <summary>
        /// 12、交易方向(买卖); 	B、上交所及中金所的买入业务；S、上交所及中金所的卖出业务；0S、深交所的卖出业务；0B、深交所的买入业务；; 字段类型 = VARCHAR2
        /// </summary>
        ...
        /// <summary>
        /// 21、币种; 	eg:人民币; 字段类型 = VARCHAR2
        /// </summary>
        public string VC_CURRENCY_NAME { get; set; }

        /// <summary>
        /// 22、投资类型; 	1、可交易；a、投机；; 字段类型 = char(1)
        /// </summary>
        ...
        /// <summary>
        /// 37、交易市场;  1、上交所A；2、深交所A；7、中金所；; 字段类型 = char(1)
        /// </summary>
