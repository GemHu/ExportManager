...
{
    public class IndexFuturesEODPrices
    {
        #region 数据库表字段常量
        ...
        /// <summary>
        /// 14、合约类型; 字段类型 = varchar(10); 	1:主力合约 2:真实合约 3:连续合约
        /// </summary>
        public const string C_FS_INFO_TYPE = "FS_INFO_TYPE";

        /// <summary>
        /// 15、操作时间; 字段类型 = datetime; 	
        /// </summary>
        public const string C_OPDATE = "OPDATE";

        /// <summary>
        /// 16、操作模式; 字段类型 = varchar(1); 	0（新记录）、1（更新/更正）、2（删除），描述对数据库需要进行的操作。对于0和1，记录内容即为最新值；对于2，所有字段内容为空。
        /// </summary>
        ...
        /// <summary>
        /// 14、合约类型; 	1:主力合约 2:真实合约 3:连续合约; 字段类型 = varchar(10)
        /// </summary>
        ...
        /// <summary>
        /// 16、操作模式; 	0（新记录）、1（更新/更正）、2（删除），描述对数据库需要进行的操作。对于0和1，记录内容即为最新值；对于2，所有字段内容为空。; 字段类型 = varchar(1)
        /// </summary>
