...
namespace Dothan.DBFFileMamager
{
    public class JSMX_SH
    {
        ...
        /// <summary>
        /// 1、市场代码; type = Character(2);
        /// </summary>
        public string SCDM { get; set; }

        /// <summary>
        /// 2、记录类型; type = Character(3);
        /// </summary>
        public string JLLX { get; set; }

        /// <summary>
        /// 3、交易方式; type = Character(3);
        /// </summary>
        public string JYFS { get; set; }

        /// <summary>
        /// 4、交收方式; type = Character(3);
        /// </summary>
        public string JSFS { get; set; }

        /// <summary>
        /// 5、业务类型; type = Character(3);
        /// </summary>
        public string YWLX { get; set; }

        /// <summary>
        /// 6、清算标志; type = Character(3);
        /// </summary>
        public string QSBZ { get; set; }

        /// <summary>
        /// 7、过户类型; type = Character(3);
        /// </summary>
        public string GHLX { get; set; }

        /// <summary>
        /// 8、交收编号; type = Character(16);
        /// </summary>
        public string JSBH { get; set; }

        /// <summary>
        /// 9、成交编号; type = Character(16);
        /// </summary>
        public string CJBH { get; set; }

        /// <summary>
        /// 10、申请编号; type = Character(16);
        /// </summary>
        public string SQBH { get; set; }

        /// <summary>
        /// 11、委托编号; type = Character(16);
        /// </summary>
        public string WTBH { get; set; }

        /// <summary>
        /// 12、交易日期; type = Character(8);
        /// </summary>
        public string JYRQ { get; set; }

        /// <summary>
        /// 13、清算日期; type = Character(8);
        /// </summary>
        public string QSRQ { get; set; }

        /// <summary>
        /// 14、交收日期; type = Character(8);
        /// </summary>
        public string JSRQ { get; set; }

        /// <summary>
        /// 15、其它日期; type = Character(8);
        /// </summary>
        public string QTRQ { get; set; }

        /// <summary>
        /// 16、委托时间; type = Character(6);
        /// </summary>
        public string WTSJ { get; set; }

        /// <summary>
        /// 17、成交时间; type = Character(6);
        /// </summary>
        public string CJSJ { get; set; }

        /// <summary>
        /// 18、业务单元1; type = Character(5);
        /// </summary>
        public string XWH1 { get; set; }

        /// <summary>
        /// 19、业务单元2; type = Character(5);
        /// </summary>
        public string XWH2 { get; set; }

        /// <summary>
        /// 20、业务单元1所属结算参与人的清算编号; type = Character(8);
        /// </summary>
        public string XWHY { get; set; }

        /// <summary>
        /// 21、结算参与人的清算编号; type = Character(8);
        /// </summary>
        public string JSHY { get; set; }

        /// <summary>
        /// 22、托管银行的清算编号; type = Character(8);
        /// </summary>
        public string TGHY { get; set; }

        /// <summary>
        /// 23、证券账号; type = Character(10);
        /// </summary>
        public string ZQZH { get; set; }

        /// <summary>
        /// 24、证券代码1; type = Character(6);
        /// </summary>
        public string ZQDM1 { get; set; }

        /// <summary>
        /// 25、证券代码2; type = Character(6);
        /// </summary>
        public string ZQDM2 { get; set; }

        /// <summary>
        /// 26、证券类别; type = Character(2);
        /// </summary>
        public string ZQLB { get; set; }

        /// <summary>
        /// 27、流通类型; type = Character(1);
        /// </summary>
        public char LTLX { get; set; }

        /// <summary>
        /// 28、权益类别; type = Character(2);
        /// </summary>
        public string QYLB { get; set; }

        /// <summary>
        /// 29、挂牌年份; type = Character(4);
        /// </summary>
        public string GPNF { get; set; }

        /// <summary>
        /// 30、买卖标志; type = Character(1);
        /// </summary>
        public char MMBZ { get; set; }

        /// <summary>
        /// 31、交收数量; type = Character(16);
        /// </summary>
        public string SL { get; set; }

        /// <summary>
        /// 32、成交数量; type = Character(16);
        /// </summary>
        public string CJSL { get; set; }

        /// <summary>
        /// 33、资金账号; type = Character(25);
        /// </summary>
        public string ZJZH { get; set; }

        /// <summary>
        /// 34、币种; type = Character(3);
        /// </summary>
        public string BZ { get; set; }

        /// <summary>
        /// 35、价格1; type = Character(17);
        /// </summary>
        public string JG1 { get; set; }

        /// <summary>
        /// 36、价格2; type = Character(17);
        /// </summary>
        public string JG2 { get; set; }

        /// <summary>
        /// 37、清算金额; type = Character(19);
        /// </summary>
        public string QSJE { get; set; }

        /// <summary>
        /// 38、印花税; type = Character(17);
        /// </summary>
        public string YHS { get; set; }

        /// <summary>
        /// 39、经手费; type = Character(17);
        /// </summary>
        public string JSF { get; set; }

        /// <summary>
        /// 40、过户费; type = Character(17);
        /// </summary>
        public string GHF { get; set; }

        /// <summary>
        /// 41、证管费; type = Character(17);
        /// </summary>
        public string ZGF { get; set; }

        /// <summary>
        /// 42、手续费; type = Character(17);
        /// </summary>
        public string SXF { get; set; }

        /// <summary>
        /// 43、其它金额1; type = Character(19);
        /// </summary>
        public string QTJE1 { get; set; }

        /// <summary>
        /// 44、其它金额2; type = Character(19);
        /// </summary>
        public string QTJE2 { get; set; }

        /// <summary>
        /// 45、其它金额3; type = Character(19);
        /// </summary>
        public string QTJE3 { get; set; }

        /// <summary>
        /// 46、实际收付; type = Character(19);
        /// </summary>
        public string SJSF { get; set; }

        /// <summary>
        /// 47、结果代码; type = Character(4);
        /// </summary>
        public string JGDM { get; set; }

        /// <summary>
        /// 48、附加说明; type = Character(40);
        /// </summary>
