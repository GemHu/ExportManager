...
namespace Dothan.DBFFileMamager
{
    public class JSMX_SZ
    {
        ...
        /// <summary>
        /// 25、印花税; type = (N); 备注：12,2
        /// </summary>
        public string MXYHS { get; set; }

        /// <summary>
        /// 26、交易经手费; type = N(12,2); 
        /// </summary>
        ...
        /// <summary>
        /// 31、结算参与人佣金; type = N(12,2); 备注：结算参与人系统自用
        /// </summary>
        ...
        /// <summary>
        /// 35、成交日期; type = C(8); 备注：CCYYMMDD
        /// </summary>
        public string MXCJRQ { get; set; }

        /// <summary>
        /// 36、清算日期; type = C(8); 备注：CCYYMMDD
        /// </summary>
        public string MXQSRQ { get; set; }

        /// <summary>
        /// 37、交收日期; type = C(8); 备注：CCYYMMDD
        /// </summary>
        public string MXJSRQ { get; set; }

        /// <summary>
        /// 38、发送日期; type = C(8); 备注：CCYYMMDD
        /// </summary>
        public string MXFSRQ { get; set; }

        /// <summary>
        /// 39、其它日期; type = C(8); 备注：CCYYMMDD
        /// </summary>
        public string MXQTRQ { get; set; }

        /// <summary>
        /// 40、市场代码; type = C(2); 备注：保留字段
        /// </summary>
